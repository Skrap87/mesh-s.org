...
<section class="hero">
  <div class="container model-layout">
    ...
    <div class="model-main">
      ...
      <div class="viewer-inline"><a class="btn btn-outline" href="viewer.php" data-variant-viewer-link>3D-Ansicht</a></div>
      <picture data-variant-hero>
        <source srcset="assets/variants/s/hero/hero.webp" type="image/webp" data-variant-hero-webp>
        <img src="assets/variants/s/hero/hero.png" data-variant-hero-img alt="MESH-S Modell" loading="lazy">
      </picture>

      <section id="telemetry">
        <h2 class="section-title">Telemetrie</h2>
        <div class="autonomy-graphs">
          <figure class="graph-card"><div class="chart" data-chart="charge" data-json="assets/variants/s/autonomy/charts/ha-charge.json" data-unit="%"></div></figure>
          <figure class="graph-card"><div class="chart" data-chart="battery" data-json="assets/variants/s/autonomy/charts/ha-battery.json" data-unit="V"></div></figure>
        </div>
      </section>

      <section id="winter"><h2 class="section-title">Winterbetrieb</h2><img src="assets/variants/s/winter/images/node_winter2.jpg" data-winter-image="1" alt="Wintereinsatz" loading="lazy"></section>
      <section id="moisture"><h2 class="section-title">Feuchtigkeit</h2><div class="chart" data-chart="humidityDual" data-json="assets/variants/s/winter/charts/humidity-in-out.json" data-unit="%"></div></section>

      <section id="assembly"><h2 class="section-title">Aufbau in 6 Schritten</h2><div class="steps-grid">
        <?php for ($i=1; $i<=6; $i++): $key='step0'.$i; ?>
          <div class="step"><img data-variant-asset="<?= $key ?>" src="assets/variants/s/assembly/step-0<?= $i ?>.png" alt="Schritt <?= $i ?>" loading="lazy"></div>
        <?php endfor; ?>
      </div></section>

      <section id="custom-parts"><h2 class="section-title">Sonderteile</h2><div class="custom-parts-grid">
        <div class="legend-item"><img data-variant-asset="enclosureGif" src="assets/variants/s/custom-parts/enclosure.gif" alt="Gehäuse" loading="lazy"></div>
        <div class="legend-item"><img data-variant-asset="lidGif" src="assets/variants/s/custom-parts/lid.gif" alt="Lid" loading="lazy"></div>
        <div class="legend-item"><img data-variant-asset="spacerPlateGif" src="assets/variants/s/custom-parts/spacer-plate.gif" alt="Spacer" loading="lazy"></div>
        <div class="legend-item"><img data-variant-asset="silicaCompartmentGif" src="assets/variants/s/custom-parts/silica-compartment.gif" alt="Silica" loading="lazy"></div>
      </div></section>
