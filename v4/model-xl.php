...
?>
      ...
      <div class="container hero-grid">
        <div>
          ...
          <h1 class="hero-title">
            ...
            <span class="hero-title__variant"> / XL</span>
          </h1>
			</div>
        ...
        <div class="hero-visual">
			<picture>
				<source srcset="../site/assets/variants/xl/hero/hero-xl.webp" type="image/webp" sizes="(max-width: 600px) 100vw, 50vw">
			<img src="../site/assets/variants/xl/hero/hero-xl.png" alt="MESH-S DIY-Solar-Mesh-Knoten" width="394" height="894" decoding="async" fetchpriority="high" srcset="../site/assets/variants/xl/hero/hero-500.png 500w, ../site/assets/variants/xl/hero/hero-1000.png 1000w" sizes="(max-width: 600px) 100vw, 50vw">
			</picture>
        </div>
      </div>
    </section>
    ...
    <script type="module">
        ...
        const modelUrl = "../site/assets/variants/xl/models/mesh-xl.glb";
      ...
      <div class="container split">
        ...
        <div class="autonomy-graphs">
          <figure class="graph-card">
            ...
            <div class="chart" data-chart="chargeCurrent" data-json="../site/assets/variants/xl/autonomy/charts/ha-charge.json" data-unit="mA" data-aria-label="Telemetrie-Diagramm" data-error-text="Diagrammdaten nicht verfügbar"></div>
          </figure>
          ...
          <figure class="graph-card">
            ...
            <div class="chart" data-chart="batteryLevel" data-json="../site/assets/variants/xl/autonomy/charts/ha-battery.json" data-unit="%" data-aria-label="Telemetrie-Diagramm" data-error-text="Diagrammdaten nicht verfügbar"></div>
          </figure>
        </div>
      </div>
    </section>
      ...
      <div class="container split">
        ...
        <div class="winter-stack">
          <figure class="winter-card">
            ...
            <img src="../site/assets/variants/xl/winter/images/coming-soon.png" data-winter-image="1" alt="MESH-S-Knoten im Freien an einem Morgen unter 0 °C mit Kondensation" width="567" height="511" loading="lazy" decoding="async" fetchpriority="low">
          </figure>
          ...
          <figure class="winter-card">
            ...
            <div class="chart" data-chart="temperature" data-json="../site/assets/variants/xl/winter/charts/ha-temperature.json" data-unit="°C" data-aria-label="Telemetrie-Diagramm" data-error-text="Diagrammdaten nicht verfügbar"></div>
          </figure>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="moisture-graphs">
          <figure class="graph-card">
            ...
            <div class="chart" data-chart="humidityDual" data-json="../site/assets/variants/xl/winter/charts/humidity-in-out.json" data-unit="%" data-aria-label="Feuchtigkeitsdiagramm" data-error-text="Diagrammdaten nicht verfügbar"></div>
          </figure>
        </div>
      </div>
    </section>
  ...
  <div class="container container-wide">
    ...
    <div class="custom-parts-grid">
      <div class="legend-item">
        <picture>
          <source srcset="../site/assets/variants/xl/custom-parts/enclosure-xl.webp"
                  type="image/webp">
          <img src="../site/assets/variants/xl/custom-parts/enclosure-xl.gif"
      ...
      <div class="legend-item">
        <picture>
          <source srcset="../site/assets/variants/xl/custom-parts/lid-xl.webp"
                  type="image/webp">
          <img src="../site/assets/variants/xl/custom-parts/lid-xl.gif"
      ...
      <div class="legend-item">
        <picture>
          <source srcset="../site/assets/variants/xl/custom-parts/spacer-plate-xl.webp"
                  type="image/webp">
          <img src="../site/assets/variants/xl/custom-parts/spacer-plate-xl.gif"
      ...
      <div class="legend-item">
        <picture>
          <source srcset="../site/assets/variants/xl/custom-parts/silica-compartment-xl.webp"
                  type="image/webp">
          <img src="../site/assets/variants/xl/custom-parts/silica-compartment-xl.gif"
    ...
    <section id="bom">
      <div class="container">
        ...
        <?php include 'content/bom-xl.php'; ?>
